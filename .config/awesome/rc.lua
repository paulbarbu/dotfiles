...
tags = {
  names = { "www", "dev", "office", "media", "misc" },
  layouts = { awful.layout.suit.max, awful.layout.suit.tile, awful.layout.suit.tile, awful.layout.suit.tile, awful.layout.suit.max }
}
